  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="flex-1 text-2xl font-medium text-nowrap text-zinc-800">
          ...
          <div className="flex justify-between">
            ...
            <button
              type="submit"
              className="cursor-pointer rounded-md bg-red-400 px-4 py-2 text-white transition hover:bg-red-500"
            >
              Delete
            </button>
          </div>
